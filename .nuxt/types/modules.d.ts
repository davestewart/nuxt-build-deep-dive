...
// Defines type-safe configuration interfaces for installed Nuxt modules.

import { NuxtModule, ModuleDependencyMeta } from '@nuxt/schema'

// Extend @nuxt/schema with module dependencies and configuration
declare module '@nuxt/schema' {
  ...
  // Resolved module options (after defaults applied)
  ...
  // User-provided module configuration (partial options)
  interface NuxtConfig {
    ...
    // Modules array with inline config support
