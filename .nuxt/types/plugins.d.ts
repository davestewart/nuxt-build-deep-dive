...
// Defines injections provided by Nuxt plugins to the app context and Vue components.

import type { Plugin } from '#app'

// Utility type to add $ prefix to plugin injections
type Decorate<T extends Record<string, any>> = { [K in keyof T as K extends string ? `$${K}` : never]: T[K] }

// Extract injection type from plugin
type InjectionType<A extends Plugin> = A extends {default: Plugin<infer T>} ? Decorate<T> : unknown

// Combined type of all plugin injections
...
// Extend NuxtApp with plugin injections
declare module '#app' {
...
// Make plugin injections available in Vue component templates
declare module 'vue' {
