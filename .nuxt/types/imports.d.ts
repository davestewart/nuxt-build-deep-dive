// Auto-import type declarations for Nuxt app composables and utilities.
// These are globally available without explicit imports in your app code.

export {}

// Global auto-import declarations
declare global {
  // Vue core - Reactivity
  ...
  // Third-party script stubs (analytics, tracking, payments)
  ...
  // MDC (Markdown Components) module
...
// Vue type re-exports for global usage
declare global {
  // @ts-ignore
...
// Vue template auto-import support (for use in template expressions)
